...
public class ShowDelete {
    String ty, op1, op2, op3, op4, a, qt;
    ShowDelete(final JFrame f, final String subject, String e)    {
        ...
        if (ty.equals("m")) {
            ...
            f.setTitle("Delete Question to Quiz");
            ...
            sub.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    ...
                    final JDialog d = new JDialog(f, "Question Deleted", true);
                    ...
                    JLabel jl = new JLabel("Question successfully deleted.");
                    d.add(jl);
            ...
            f.setTitle("Delete a Fill in the Blank question from Quiz");
            JLabel qe = new JLabel();
            ...
            af.setText(a);
            qe.setText("The question is:");
            ans.setText("The answer is:");
            JButton back = new JButton("Back");
            JButton sub = new JButton("Delete");
            ...
            f.setTitle("Delete a True or False question from Quiz");
            JLabel qe = new JLabel();
